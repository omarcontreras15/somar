...
class Categoria extends Controller{
    ...
    public function listarCategorias(){
        ...
        $ventana = $this->getTemplate("./app/views/admin/categoria/consultarCategoria/administrarCategoria.html");
        ...
        $option = "";
        $elementotabla = $this->getTemplate("./app/views/admin/categoria/consultarCategoria/components/body-tabla-categoria.html");
        if($sizeArray>0){
    ...
    public function cargarAgregarCategoria(){
         //varifica si hay o no una sesion iniciado, dependiendo del caso cargar el menuBar
        $menu=$this->cargarMenuBarAdmin();
        $contenido = $this->getTemplate("./app/views/admin/categoria/agregarCategoria/agregarCategoria.html");
    ...
    public function cargarEditarCategoria($id){
         //varifica si hay o no una sesion iniciado, dependiendo del caso cargar el menuBar
        $menu=$this->cargarMenuBarAdmin();
        $contenido = $this->getTemplate("./app/views/admin/categoria/editarCategoria/editarCategoria.html");
